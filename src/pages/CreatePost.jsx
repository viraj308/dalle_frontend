  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-12 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p3 h-64 flex justify-center items-center mt-4'>
          {
            form.photo ? (
