  ...
  const generateImage = async () => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch("https://dall-e-wu1u.onrender.com/api/v1/dalle",{ 
        method: "POST",
        headers: {
...
const handleSubmit = async (e) => {
  ...
  if (form.prompt) {
    setLoading(true);
    try {
      const response = await fetch('https://dall-e-wu1u.onrender.com/api/v1/posts', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  return (
    <section className='max-w-7xl mx-auto'>
       <div>
        ...
        <p className='mt-2 text-[#666e75] dark:text-slate-400 text-[16px] max-w-[500px]'>Create imaginative and visually stunning images generated by DALL-E AI</p>
      </div>
      ...
      <form className='mt-12 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='relative bg-gray-50 dark:bg-[#383838] border-gray-300 dark:border-none text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p3 h-64 flex justify-center items-center mt-4'>
          ...
          {
              generatingImg && (
                <div className='absolute inset-0 z-0 flex justify-center items-center bg-[rgba(85,78,78,0.5)] dark:bg-[rgba(150,150,150,0.5)] rounder-lg'>
                  <Loader />
                </div>
              )
          }
        ...
        <div className='mt-7'>
          ...
          <div className='mt-10'> 
            <p className='mt-2 text-[#666e75] dark:text-slate-400 text-[14px]'> Once you have created the image you want, you can share it with others in the community</p>
